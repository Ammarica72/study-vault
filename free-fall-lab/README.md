...
The full description of the project can be found at http://localhost/physics. 
Scroll down till you get to labs, and click on Free fall.  

![Project Screenshot](showme1.png)
...
3 - And excel sheet student can use to populate their data and get a graph for distance vs the t<sup>2</sup>.  
